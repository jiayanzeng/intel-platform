...
|---|---|---|---|
| T7 robots single-flight | a second concurrent harvester | v0.34 · 2026-08-02 — Step 6's isolated local and hosted test runtimes started no harvester, made no publisher request, and never created a second concurrent harvest caller; trigger did not fire | none |
...
| Live multi-publisher behaviour in one runtime | further origins beyond the two configured, or concurrency | v0.34 · 2026-08-02 — Step 6 exercised only fixture/test runtimes: no live publisher runtime, third origin, or concurrency ran; trigger did not fire | none — complete, do not re-exercise |
...
| R3/R4 open-bottom coverage | a spelling outside registered vocabulary | v0.34 · 2026-08-02 — the exact candidate's registered 12-rule / 68-control vocabulary passed in hosted verification and no new spelling appeared; trigger did not fire | none |
