...
- [x] **R-CLOSE** — version choice recorded with reasoning; v0.11.0's disposition in `CHANGELOG.md`; `ARCHITECTURE.md` matches enforced reality; A4 and the Step 7 residual both still open
