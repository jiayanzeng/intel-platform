...
| review-export size and retention bound (v0.28) | **Accepted at a 3,000,000-byte ceiling and two-cycle retention depth — operator selected 2026-08-02** | the project-root review export exceeds **3,000,000 bytes**, its cycle-document set differs from the active cycle plus the immediately prior execution cycle, the pinned SEC RSS body reappears, or any `docs/state-archive/**` byte reappears | v0.37 · 2026-08-03 — STATE-ARCHIVE's project-root delivered worktree export passed at **2,558,258 bytes / 154 files / 2 retained cycles**, with exactly the v0.36–v0.37 task/progress pairs retained and both protected byte classes excluded. This new structural baseline is **41,742 bytes** below C10's 2,600,000-byte target and leaves **441,742 bytes / 14.72% / 3.08 cycles** at the latest +143,456-byte adjacent-cycle denominator. The closed-tree governed referent remains v0.36 R-CLOSE's exact release parent `9946cedae75d99c53d17a6f8b5507d10cb9bd959` at an export of **2,885,942 bytes / 154 files / 2 retained cycles** until the Step 3 implementation commit is measured and its append-only governed field exists. The distinct-cycle progress-backed governed series remains **2,742,486 → 2,885,942 (+143,456)**. Its **114,058-byte / 3.80%** remainder is **0.80 cycles** at that latest adjacent-cycle denominator. Review-export margin: kind=`governed→governed`; prior_progress=`docs/cycles/PROGRESS-v0.35.md`; prior_bytes=`2742486`; current_progress=`docs/cycles/PROGRESS-v0.36.md`; current_bytes=`2885942`; evaluated_progress=`docs/cycles/PROGRESS-v0.36.md`; evaluated_bytes=`2885942`; denominator_bytes_per_cycle=`143456`; numerator_bytes=`114058`; cycles=`0.80`. Neither byte, retention, nor protected-content trigger fired. Governed review-export bytes: `2885942`. |
