...
| 5 | `TASKS-v0.6.md:3`, `TASKS-v0.7.md:3` | Both formerly carried the present-tense authority claim corrected in v0.10. `TASKS-v0.7.md:13` also asserted Rust "≥ 1.75 still suffices for the offline build", which `STATE.md §5` records as **false** — the committed lock is format v4 and the floor is **1.78**. |
