# intel-platform (v0.15.5 — core-shell)
...
`v0.15.5` is the selected release identity. Its release-posture hosted
evidence is workflow-dispatch run `30432249637`, attempt 1, against exact
evidence candidate `3f61aed183e195ccaf952cbc7f4528712bab028d` on neutral
branch `candidate/v0.15.4-v0.21`. Signed receipts pin that candidate and source
ref; the cycle closing record separately identifies the later release commit.
The annotated `v0.15.5` tag targets the release commit, not the candidate.
...
[`TASKS-v0.21-EXECUTION.md`](docs/cycles/TASKS-v0.21-EXECUTION.md) and
[`PROGRESS-v0.21.md`](docs/cycles/PROGRESS-v0.21.md).
