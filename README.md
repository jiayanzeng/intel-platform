# intel-platform (v0.15.4 — core-shell)
...
`v0.15.4` is the selected release identity. Its release-grade hosted evidence
is workflow-dispatch run `30423736121`, attempt 1, against exact evidence
candidate `8230d4f24f565afcde92931c987adff4339036af` on
`candidate/v0.15.4`. Signed receipts pin that candidate and source ref; the
cycle closing record separately identifies the later release commit. The
annotated `v0.15.4` tag targets the release commit, not the candidate.
...
[`TASKS-v0.20-EXECUTION.md`](docs/cycles/TASKS-v0.20-EXECUTION.md) and
[`PROGRESS-v0.20.md`](docs/cycles/PROGRESS-v0.20.md).
