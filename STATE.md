...
- This checkout still has no Git remote and no observed CI-runner execution.
  The release evidence is the measured local matrix; workflow configuration is
  not represented as a runner result.
