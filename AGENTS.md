...
**`docs/cycles/TASKS-v0.37-EXECUTION.md`**. Every completed step is logged in
**`docs/cycles/PROGRESS-v0.37.md`**. The declaration points at the open cycle
...
## 9. Cycle execution — standing operator authorization
