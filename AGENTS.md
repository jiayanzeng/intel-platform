...
**Active cycle:** v0.10.2

Task work for this declared cycle is ordered in
**`TASKS-v0.10.2-EXECUTION.md`**. Every completed step is logged in
**`PROGRESS-v0.10.2.md`**. The declaration points at the open cycle while work
